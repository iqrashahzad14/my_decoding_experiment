...
try
    ...
    for iBlock = 1:cfg.design.nbBlocks
        ...
        for iEvent = 1:cfg.design.nbEventsPerBlock
            ...
            if cfg.design.blockOrder(iBlock)<=cfg.design.nbRepetitions/2  %visual blocks 
                [onset, duration, dots] = doDotMo(cfg, thisEvent, thisFixation, dots);
            elseif cfg.design.blockOrder(iBlock)>cfg.design.nbRepetitions/2 %tactile blocks
            ...
            thisEvent.trial_type = strcat(thisEvent.modality_type,'_', thisEvent.trial_type);
